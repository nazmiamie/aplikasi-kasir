...
this.setLocation(x, y);
   ...
   private void clear(){
    ...
    private void table_barangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_barangMouseClicked
        ...
        kd.nam = table_barang.getValueAt(tab, 1).toString();
        kd.kg = table_barang.getValueAt(tab, 2).toString();
        kd.jj = table_barang.getValueAt(tab, 3).toString();
        kd.har = table_barang.getValueAt(tab, 4).toString();
        kd.itemTerpilih();
        this.dispose();
